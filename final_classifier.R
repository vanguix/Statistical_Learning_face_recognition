final_classifier <- function(name){
  # INPUT
  ...
  #    means_pca - the vector of the means from PCA
  #    target - vector of labels
  #     W - transformation matrix from Fisher
  #     means_fisher -  the vector of the means from FDA
  #     train_fisher - the matrix of the training data once applied FDA
  #     D_Fisher - the vector that specifies which percentage of variance is retained per each Fisher component
  #     our_knn_single - KNN function
